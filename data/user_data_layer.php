<?php
    ...
    function insert_item_cart($user,$itemID,$color,$quant,$total,$cartID,$tam){
            $servername = "localhost";
            $username = "root";
            $pass = "root";
            $DB = "BABUSHA";
            ...
            if ($conn -> connect_error){
                ...
                $sql = "INSERT INTO CarrIt (c_id,i_id,cantidad,color,precioTotal,tamano)
                VALUES('$cartID','$itemID','$quant','$color','$total','$tam')";
        ...
        if ($conn -> connect_error){
            ...
            if ($result -> num_rows > 0){
                while ($row = $result->fetch_assoc()){
                    $response = array( "id" => $row["i_id"],"item" => $row["nombre"], "desc" => $row["descripcion"], "color" => $row["color"], "quant" => $row["cantidad"], "total" => $row["precioTotal"], "carrItId" => $row["carrItID"], "c_id" => $row["c_id"], "tamano" => $row["tamano"]);
    ...
    function loading_my_orders($user){
        $servername = "localhost";
        $username = "root";
        $pass = "root";
        $DB = "BABUSHA";
