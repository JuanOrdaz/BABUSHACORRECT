<?php
    ...
    switch($action){
        ...
        case "VIEW_ORDERS": loa_orders();
                                break;
        case "VIEW_MY_ORDERS": loa_my_orders();
                        break;
    ...
    function register_user(){
        ...
        $tel = $_POST["tel"];
        $create_new_cart = new_cart($uName);
    ...
    function insert_item(){
        ...
        $result = insert_item_cart($user,$itemID,$color,$quant,$total,$unique_cart["id"],$tam);
    }
    ...
    function loa_my_orders(){
        $user = $_SESSION['username'];
        
        $result = loading_my_orders($user);
    }
